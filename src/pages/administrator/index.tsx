...
const Administrator = () => {
  ...
  return (
    <div className="mt-[60px] lg:ml-[250px] bg-[#2a2a31] min-h-[calc(100vh-60px)] lg:h-full px-10 py-8 pb-7">
      <div className="text-white font-bold text-2xl mb-10">Administrators </div>
      <div className='text-[#DDDDDD]'>
        <div className='bg-[#232329] p-5 mt-5'>
          <div className='uppercase font-bold text-sm mb-7'>administrator Lookup</div>
          <div className='grid grid-cols-2 gap-4'>
            ...
            <div className='col-span-2 lg:col-span-1'>
              ...
              <select name="" id="" className='bg-transparent focus:bg-transparent border-2 border-[#333339] text-[#DDDDDD] !text-[#DDDDDD] focus-visible:border-1 focus-visible:border-[#70BBFD] focus-visible:outline-none block h-[38px] w-full text-sm'>
                <option disabled selected className='bg-[#232329] text-[#AAAAAA]'>Date Range Dropdwon</option>
      ...
      <div className='flex items-center mt-5'>
        ...
        <div className='uppercase text-sm font-bold text-[#DDDDDD] ml-3'>add new admin</div>
      </div>
      ...
      <div className='text-[#DDDDDD] text-xs'>
        ...
        {users.map((item: any, index: number) => {
          return <div key={"administrator"+index}>
            ...
            <div className='basis-[10%]'>
              {item.blockedstatus && <img src={Check} alt="Check" />}
              {!item.blockedstatus && <img src={X} alt="X" />}
            </div>
